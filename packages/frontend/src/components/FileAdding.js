...
const FileAdding = (props) => {
    ...
    const getExtensionAndName = (string) => {
        ...
        return {
            extension: string.slice(lastIndex + 1),
            name: string.slice(0, lastIndex),
        }
    }
            ...
            if (user) {
                try {
                    ...
                    try {
                        ...
                        if (props.fileIsLecture) {
                            console.log("MM DUPA EDZI")
                        } else {
        ...
        <>
            <div className="file-container">
                <div {...getRootProps({ style })}>
                    ...
                    <input {...getInputProps()} />
                    <div>
                        {filepath.length === 0 ? "Przenies i upuść" : filepath}
                    </div>
                    {uploading === true ? (
                        <ProgressBar
                            bgcolor={"#6a1b9a"}
